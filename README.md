...
* `snmp_listen_ip` defaults to undef. If you pass in a ip address, it will be defined automatically. [snmp_listen_ip entries](http://www.squid-cache.org/Doc/config/snmp_incoming_address/).
