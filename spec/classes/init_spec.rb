...
describe 'squid' do
  ...
  context 'with defaults for all parameters' do
    ...
    it { should contain_concat_fragment('squid_header').with_content(/^access_log\s+daemon:\/var\/logs\/squid\/access.log\s+squid$/) }
  ...
  context 'with all parameters set' do
     ...
     it { should contain_concat_fragment('squid_header').with_content(/^access_log\s+\/var\/log\/out.log$/) }
     it { should contain_concat_fragment('squid_header').with_content(/^coredump_dir\s+\/tmp\/core$/) }
